...
function enableDirtyFormCheck(formSelector, options) {
    ...
    // Delay snapshotting the formâ€™s data to avoid race conditions with form widgets that might process the values.
    // User interaction with the form within that delay also wonâ€™t trigger the confirmation message.
    setTimeout(function() {
